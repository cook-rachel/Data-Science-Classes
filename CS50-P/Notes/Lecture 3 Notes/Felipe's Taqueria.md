...
```
```meta-bind-button
label: "Next: Problem Set - Grocery List"
icon: "arrow-right"
hidden: true
...
```
```meta-bind-button
label: "Previous: Problem Set - Fuel Gauge"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
