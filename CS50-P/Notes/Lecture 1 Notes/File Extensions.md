...
university: Harvard
year: "2022"
link: https://cs50.harvard.edu/python/psets/1/extensions/
cover: fileextensions.jpg
description: "In a file called `extensions.py`, implement a program that prompts the user for the name of a file and then outputs that file’s media type if the file’s name ends, case-insensitively, in any of these suffixes: gif, jpg, jpeg, png, txt, zip."
---
...
```
```meta-bind-button
label: "Next: Problem Set - Math Interpreter"
icon: "arrow-right"
hidden: true
...
actions:
  - type: open
    link: "[[Math Interpreter]]"

```
```meta-bind-button
label: "Previous: Problem Set - Home Federal Savings Bank"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
...
actions:
  - type: open
    link: "[[Home Federal Savings Bank]]"
