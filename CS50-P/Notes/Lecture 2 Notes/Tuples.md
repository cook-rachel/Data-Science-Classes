...
university: Harvard
year: "2022"
link: https://cs50.harvard.edu/python/shorts/tuples/
cover: tuples.jpg
description: Supplemental on tuples, which are similar to lists but can't be changed once written.
---
...
```
```meta-bind-button
label: "Previous: Short - String Slicing"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
