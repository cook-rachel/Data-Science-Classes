...
```
```meta-bind-button
label: "Next: Problem Set - Bitcoin Price Index"
icon: "arrow-right"
hidden: true
...
```
```meta-bind-button
label: "Previous: Problem Set - Guessing Game"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
