...
university: Harvard
year: "2022"
link: https://cs50.harvard.edu/python/weeks/8/
cover: ooprogramming.jpg
...
```
```meta-bind-button
label: "Previous: Problem Set - Response Validation"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
...
actions:
  - type: open
    link: "[[Response Validation]]"

```
# Lecture 8: Object-Oriented Programming
---

<iframe width="640" height="360" src="https://www.youtube.com/embed/e4fwY9ZsxPw" title="CS50P - Lecture 8 - Object-Oriented Programming" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
