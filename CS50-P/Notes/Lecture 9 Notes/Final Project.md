...
university: Harvard
year: "2022"
link: https://cs50.harvard.edu/python/project/
cover: finalproject.jpg
description:
---
...
```
```meta-bind-button
label: "Previous: Short - Recursion"
icon: "arrow-left"
hidden: true
class: navigation-buttons
tooltip: ""
...
Note that CS50’s staff audits submissions to CS50P including this final project. Students found to be in violation of [the Academic Honesty policy](https://cs50.harvard.edu/python/#honesty) will be removed from the course and deemed ineligible for a certificate. Students who have already completed CS50P, if found to be in violation, will have their CS50 Certificate (and edX Certificate, if applicable) revoked.

## When to Do It

By [Tuesday, June 30, 2026 at 5:59 PM MDT](https://time.cs50.io/20260630T235900Z).
